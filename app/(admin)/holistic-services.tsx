...
export default function AdminHolisticServicesScreen() {
  ...
  const load = useCallback(async (isRefresh = false) => {
    ...
    try {
      ...
      console.error('Holistic services load error:', e);
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
  ...
  return (
    ...
    >
      ...
      {list.length === 0 && (
        <Text style={[styles.empty, { color: c.mutedForeground }]}>No hay servicios holísticos</Text>
      )}
